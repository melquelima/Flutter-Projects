...
import 'package:login_api/controllers/statements_controller.dart';
...
class _StatementsTabState extends State<StatementsTab>
  ...
  void initState() {
    ...
    StatementsController.instance.LoadStatements(context,"1000109809").then((value) {
      if (mounted) {
        setState(() {
          isLoading = false;
          print("AGORA SIM");
  ...
  Widget contasTab() {
    return ListView.builder(
      ...
      itemCount: StatementsController.instance.statements.length,
      itemBuilder: (context, index) {
        return account_card(StatementsController.instance.statements[index]);
      },
    );
  }

  Widget account_card(Statement acc) {
    return Padding(
